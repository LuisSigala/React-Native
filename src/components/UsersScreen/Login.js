...
const imageBackground = {
    uri: 'https://images8.alphacoders.com/903/thumb-1920-903481.jpg',
};
...
class Login extends React.Component {
    ...
    //It creates a component with the things that have inside
    componentDidMount = () => {
        this.deleteTokens();
    };

    //This call the logout function from the UserSsesion file
    deleteTokens = async () => {
        await UserSession.instance.logout();
    };

    //This calls the login function to the login of the user,
    //also handle errors and a place to send the user
    handleSubmit = async () => {
        try {
    ...
    //This change the the type of icon and if the text will be seen or not
    ...
    //It allows the user to go to the Signup view
    handleSignUp = async () => {
