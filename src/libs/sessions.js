...
class UserSession {
    ...
    login = async body => {
        try {
            let request = await fetch(`https://django-api-ex.herokuapp.com/users/login/`, {
                method: 'POST',
                headers: {
    ...
    signup = async body => {
        try {
            let request = await fetch(`https://django-api-ex.herokuapp.com/users/signup/`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
